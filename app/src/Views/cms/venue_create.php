    ...
    <main class="mx-auto max-w-4xl p-4 py-8">
        <section class="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-slate-200">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Create Venue</h1>
                    <p class="mt-1 text-sm text-slate-600">Add a venue used by jazz events.</p>
                </div>
            ...
            <form method="POST" action="/cms/venues/create" class="mt-6 space-y-6">
