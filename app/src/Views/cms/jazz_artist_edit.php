    ...
    <main class="mx-auto max-w-6xl p-4 py-8">
        <section class="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-slate-200">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Edit Jazz Artist</h1>
                    <p class="mt-1 text-sm text-slate-600">
                        Artist ID: <span class="font-medium text-slate-900"><?= (int)$artist->artist_id ?></span>
                        · Page ID: <span class="font-medium text-slate-900"><?= $artist->page_id !== null ? (int)$artist->page_id : 'none' ?></span>
                    </p>
                </div>
            ...
            <?php
            $formAction = '/cms/jazz/artists/' . (int)$artist->artist_id;
