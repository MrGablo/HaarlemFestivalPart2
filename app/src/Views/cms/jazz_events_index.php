                        ...
                        <?php else: ?>
                            <?php foreach ($events as $e): ?>
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 text-slate-700">
                                        <?= htmlspecialchars((string)($e->artist_name ?? '-')) ?>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 text-slate-700">
                                        <?= htmlspecialchars((string)($e->start_date ?? '')) ?>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 text-slate-700">
                                        <?= htmlspecialchars((string)(!empty($e->venue_name) ? $e->venue_name : '-')) ?>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 text-slate-700">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <form method="POST" action="/cms/events/jazz/<?= (int)$e->event_id ?>/delete"
