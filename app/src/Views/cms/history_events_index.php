...
<head>
    ...
    <title>CMS History Events</title>
    ...
    <main class="mx-auto max-w-6xl p-4 py-8">
        <section class="rounded-2xl bg-white p-6 shadow-xl ring-1 ring-slate-200">
            <div class="flex items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight text-slate-900">History Events</h1>
                    <p class="mt-1 text-sm text-slate-600">Create, edit, and delete the bookable history tours.</p>
                </div>

                <div class="flex items-center gap-3">
                    <a href="/cms/events/history/create"
                        ...
                        <?php else: ?>
                            <?php foreach ($events as $e): ?>
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 text-slate-700"><?= htmlspecialchars((string)$e->language) ?></td>
                                    ...
                                    <td class="min-w-[220px] whitespace-nowrap px-4 py-3">
                                        <div class="flex flex-nowrap items-center gap-2">
                                            ...
                                            <form method="POST"
                                                  action="/cms/events/history/<?= (int)$e->event_id ?>/delete"
                                                  onsubmit="return confirm('Delete this history event? This cannot be undone.');">
